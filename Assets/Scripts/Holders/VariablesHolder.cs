...
namespace EV
{
    ...
    public class VariablesHolder : ScriptableObject
    {
        ...
        public void UpdateCharacterName(string inputName)
        {
            characterName.value = inputName;
            updateCharacterName.Raise();
        }
    }
}
